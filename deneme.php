...
<body>
	...
	<div id="menubar">
		<ul id="menuUl">
			<li class="menuli">
			<img class="iconpic" src="../icon/Homew.png"/>Anasayfa
			</li>
			<li class="menuli">
			...
			<li class="menuli">
				<img class="iconpic" src="../icon/profile.png"/>
				A.Ü. Görevli İşlemleri
			</li>
			<li class="menuli">
				<img class="iconpic" src="../icon/news.png"/>
				AÖF'ten Haberler</li>
			<li class="menuli">
				<img class="iconpic" src="../icon/telepnone.png"/>
				İletişim
			</li>
		</ul>
	</div>
	...
	<div id="duyurular">
		...
		<div id="duyurularalti">
			...
			<div id="autoDate">
				...
				//echo date("G:i:s");
				?>
				<script src="http://ic.sitekodlari.com/tarihvesaat1.js"></script>
			</div>
		</div>
		<div><hr class="duyuruline">
			<img class="duyururesim" src="../images/exam.jpg"/>
			<label class="basliklar">DUYURU 1</label>
		...
		<div><hr class="duyuruline">
			...
			<label class="basliklar">DUYURU 2</label>
			<p class="metinler">Lorem Ipsum, adı bilinmeyen bir matbaacının bir hurufat 
			numune kitabı oluşturmak üzere bir yazı galerisini alarak karıştırdığı 1500'lerden 
			beri endüstri standardı sahte metinler olarak kullanılmıştır. Beşyüz yıl boyunca 
			varlığını sürdürmekle kalmamış, aynı zamanda pek değişmeden elektronik dizgiye.</p>
		...
		<div><hr class="duyuruline">
			...
			<label class="basliklar">DUYURU 3</label>
			<p class="metinler">Lorem Ipsum, adı bilinmeyen bir matbaacının bir hurufat 
			numune kitabı oluşturmak üzere bir yazı galerisini alarak karıştırdığı 1500'lerden 
			beri endüstri standardı sahte metinler olarak kullanılmıştır. Beşyüz yıl boyunca 
			varlığını sürdürmekle kalmamış, aynı zamanda pek değişmeden elektronik dizgiye.</p>
		...
		<div><hr class="duyuruline">
			...
			<label class="basliklar">DUYURU 4</label>
			<p class="metinler">Lorem Ipsum, adı bilinmeyen bir matbaacının bir hurufat 
			numune kitabı oluşturmak üzere bir yazı galerisini alarak karıştırdığı 1500'lerden 
			beri endüstri standardı sahte metinler olarak kullanılmıştır. Beşyüz yıl boyunca 
			varlığını sürdürmekle kalmamış, aynı zamanda pek değişmeden elektronik dizgiye.</p>
